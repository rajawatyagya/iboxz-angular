...
function startup(onMessage) {
    self.onmessage = function(event) {
		var pocketsphinxJS = (event.data && event.data.length && (event.data.length > 0)) ? event.data : '../../../assets/js/pocketsphinx.js';
		var pocketsphinxWASM = (event.data && '../../../assets/js/pocketsphinx.wasm' in event.data) ? event.data['../../../assets/js/pocketsphinx.wasm'] : '../../../assets/js/pocketsphinx.wasm';
