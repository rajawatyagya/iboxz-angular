...
dependencies = ['../../../assets/js/recorder.js',
                '../../../assets/js/callbackmanager.js',
                '../../../assets/js/volumemeter.js',
                '../../../assets/js/constants.js']

getScripts(dependencies, function (constraints) {
    ...
    $(document).ready(function (constraints) {
      callbackManager = new CallbackManager();
      spawnWorker("../../../assets/js/recognizer.js", function(worker) {
      ...
      function get_intelligibility_score(feats, word) {
        // var service_url = "https://tools.wmflabs.org/proneval-gsoc17/pronserv";
          const service_url = "http://localhost:5555/pronserv";
